...
class ModelerPipeline:
    ...
    def fit(self):
        ...
        if self.grid_search==False:
            ...
            self.pipeline_clf = Pipeline(steps=[('clf',KNeighborsClassifier())]) # create model pipeline
    ...
    def predict(self,model_name=None,df_test=None,y_test=None,imputer_func_dict=None,
                save_path="../../predictions/",label_col="hospital_death",id_col="encounter_id"):
        ids=None
        ...
        if y_test is not None: #for test set labels given 
            ...
            vz.plot_roc_auc(fpr,tpr,roc_auc)
